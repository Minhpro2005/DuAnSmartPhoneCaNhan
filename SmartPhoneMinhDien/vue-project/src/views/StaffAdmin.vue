        ...
        <div class="modal-content">
          <form @submit.prevent="submitNhanVien">
            ...
            <div class="modal-body">
              ...
              <input v-model="form.ngaySinh" type="date" class="form-control mb-2" placeholder="Ngày sinh" />
...
export default {
  ...
  methods: {
    fetchNhanVien() {
      fetch("http://localhost:8080/smartphone/nhanvien")
        .then(res => res.json())
        .then(data => {
          this.nhanViens = data;
        });
    ...
    editNhanVien(nv) {
      ...
      this.previewImage = nv.hinhAnh ? 'http://localhost:8080' + nv.hinhAnh : '';
      this.selectedImage = null;
      bootstrap.Modal.getOrCreateInstance(document.getElementById('nvModal')).show();
    },
    handleImageUpload(e) {
    ...
    submitNhanVien() {
      ...
      formData.append('ngaySinh', this.form.ngaySinh || '');
      ...
      const url = this.isEditing
        ...
        : `http://localhost:8080/smartphone/nhanvien/create`;
